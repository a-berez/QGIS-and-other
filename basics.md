...
<details>
	<ol>
	<li>Нужно <a href="https://360.yandex.ru/disk/download/">скачать</a> десктопное приложение Яндекс.Диска для Windows</li>
	<li>После скачивания запускаем приложение, ему потребуется несколько минут, чтобы установиться</li>
	<li>После установки откроется окно авторизации. Вводим там данные аккаунта, который используется как основной при работе с диском
	<img src="pics/basics/basics1.png" /></li>
	<li>После успешной авторизации Яндекс.Диск предложит подключить автосохранение папок. По сути это вариант бэкапа и это можно сделать для локальных папок на компьютере
	<img src="pics/basics/basics2.png" /></li>
	</li>Чтобы понять, куда по умолчанию сохраняются данные с Яндекс.Диска, заходим в «Файл» → «Настройки»
	<img src="pics/basics/basics3.png" /></li>
	<li>Откроется окно, в котором нужно нажать «Настроить расположение папок»
	<img src="pics/basics/basics4.png" /></li>
	<li>В появившемся окне можно увидеть, куда будут сохраняться материалы с Яндекс.Диска при синхронизации. При необходимости можно изменить значения по умолчанию.
	<img src="pics/basics/basics5.png" /></li>
	<li>Для работы с файлами из папки на Яндекс.Диске как с обычнми файлами нажать правой кнопкой мыши на папку или файл и выбрать «Сохранить на компьютере»
	<img src="pics/basics/basics6.png" /></li>
	<li>Теперь можно работать с файлами с Яндекс.Диска как с обычными, в том числе и в различных программах (например, QGIS или Adobe InDesign).</li>
</details>
#### Компьютеры на MacOS
