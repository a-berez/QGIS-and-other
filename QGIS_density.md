...
[4] — выражение (о нём [ниже](QGIS_density.md#про-выражение))   
...
2. После этого в калькуляторе добавляем к данным, которые мы получили в [п. 3](QGIS_density.md#3-расчёт-населения-каждого-дома) примерное значение средней численности жителей таких домов (обычно, где-то между 2 и 3)
...
3. Используя статистическое саммари, узнаём сумму населения, вычисленную в [п. 3](QGIS_density.md#3-расчёт-населения-каждого-дома)     
...
6. Обновляем поле с численностью, воспользовавшись формулой из [п. 3](QGIS_density.md#про-выражение)    
